                ...
                <section className="px-3 sm:px-10">
                    ...
                    <div className="flex justify-between h-max gap-3 mb-10">
                        ...
                        {businessData.contacto != undefined ?
                            ...
                            >
                                <a href={`tel:${businessData.contacto}`}>Llamar</a>
                            </button> : undefined
                        }
                        ...
                        {businessData.contacto != undefined ?
                            ...
                            >
                               <a target="_blank" href={`https://api.whatsapp.com/send?phone=${businessData.contacto}&text=Hola *${businessData.nombre}* te vi en Yogo App 🥳%0 https://yogoapp.co/sites/${businessData.user}`}>WhatsApp</a>
                            </button> : undefined

                        }

                        {businessData.cordenadas != undefined ?
                            <button
                                className="bg-blue rounded-md text-white font-medium font-inter py-[5px] sm:py-[10px]"
                            >
                                <a target="_blank" href={`https://www.google.com/maps/place/${businessData.cordenadas}`}>¿Como llegar?</a>
                            </button> : undefined
